      ...
      <div className='row'>
        <div className='column1'>
          <div className='heading'>
            ...
            <h6>
              <p>
                Teams relating to various academic spheres that organize events
                before, during and after Aaruush
              </p>
            </h6>
          </div>
          <br></br>
          <div class='card'>
            ...
            <div class='text'>
              ...
              <h6 id='para2'>
                Concept, designing, form follows functions and Digital Modeling
              </h6>
            </div>
          </div>
          <br></br>
          ...
          <div class='card'>
            ...
            <div class='text'>
              ...
              <h6 id='para2'>
                Virtual Competitions, Problem Solving Skills, Online Challenges
              </h6>
            </div>
          </div>
          <br></br>
        ...
        <div className='column2'>
          ...
          <div class='card'>
            ...
            <div class='text'>
              ...
              <h6 id='para2'>
                Fund Allocation, Management of Expenses and Income and Printing.
              </h6>
            </div>
          </div>
          <br></br>
          ...
          <div class='card'>
            ...
            <div class='text'>
              ...
              <h6 id='para2'>
                Plans social initiatives and events which create a difference in
                society.
              </h6>
            </div>
          </div>
