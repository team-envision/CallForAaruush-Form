...
import publicrelations from '../publicrelations.png';
import qualityassurance from '../qualityassurance.png';
import finance from '../finance.png';
import operationandresourcemanagement from '../operationandresourcemanagement.png';
import corporatestrategyandimplementation from '../corporatestrategyandimplementation.png';
import highlights from '../highlights.png';
import sponsorship from '../sponsorship.png';
import initiatives from '../initiatives.png';
        ...
        <div className='row'>
          <div className='column1'>
            <div className='heading'>
              ...
              <h6>
                <p>
                  Teams relating to various academic spheres that organize
                  events before, during and after Aaruush
                </p>
              </h6>
            </div>
            <br></br>
            <div class='card'>
              <img src={one}></img>
              <div class='text'>
                <h4 id='para1'>Architecture</h4>
                <h6 id='para2'>
                  Concept, designing, form follows functions and Digital
                  Modeling
                </h6>
            ...
            <div class='card'>
              <img src={digital}></img>
              <div class='text'>
                <h4 id='para1'>Digital Design</h4>
                <h6 id='para2'>
                  Digital art, Graphic Visualization, Visual communication
                </h6>
            ...
            <div class='card'>
              <img src={on}></img>
              <div class='text'>
                <h4 id='para1'>Online</h4>
                <h6 id='para2'>
                  Virtual Competitions, Problem Solving Skills, Online
                  Challenges
                </h6>
            ...
            <div class='card'>
              <img src={present}></img>
              <div class='text'>
                <h4 id='para1'>Praesentatio</h4>
                <h6 id='para2'>
                  Communication Skills, Oratory Events, Presentation Scopes
                </h6>
            ...
            <div class='card'>
              <img src={robot}></img>
              <div class='text'>
                <h4 id='para1'>Robogyan</h4>
                <h6 id='para2'>
                  Autonomous Robotic Systems, Machine Learning, Artificial
                  Intelligence
                </h6>
            ...
            <div class='card'>
              <img src={zone}></img>
              <div class='text'>
                <h4 id='para1'>Xzone</h4>
                <h6 id='para2'>
                  Competitive gaming, game development, SRM roadies
                </h6>
            ...
            <div class='card'>
              <img src={yudh}></img>
              <div class='text'>
                <h4 id='para1'>Yudhamme</h4>
                <h6 id='para2'>
                  Competitive Programming, Web Design, Networking, Application
                  Development
                </h6>
          ...
          <div className='column2'>
            <div className='heading'>
              ...
              <h6 className='small'>
                Multifaceted management teams of Aaruush that organize and
                administer the fest.
              </h6>
            </div>
            <br></br>
            <div class='card'>
              <img src={publicrelations}></img>
              <div class='text'>
                <h4 id='para1'>Public Relations</h4>
                <h6 id='para2'>
                  Content Creation, Emceeing, Documentation, Scripting
                </h6>
            ...
            <br></br>
            <div class='card'>
              <img src={qualityassurance}></img>
              <div class='text'>
                <h4 id='para1'>Quality Assurance</h4>
                <h6 id='para2'>
                  Data analysis, SWOT Reports, Accommodation of external
                  participants
                </h6>
            ...
            <div class='card'>
              <img src={finance}></img>
              <div class='text'>
                <h4 id='para1'>Finance</h4>
                <h6 id='para2'>
                  Fund Allocation, Management of Expenses and Income and
                  Printing.
                </h6>
            ...
            <br></br>
            <div class='card'>
              <img src={operationandresourcemanagement}></img>
              <div class='text'>
                <h4 id='para1'>ORM</h4>
                <h6 id='para2'>
            ...
            <br></br>
            <div class='card'>
              <img src={corporatestrategyandimplementation}></img>
              <div class='text'>
                <h4 id='para1'>Corporate Strategy & Implementation</h4>
                <h6 id='para2'>
                  On-ground army of Aaruush, Sales and Publicity, crowd control,
                  crisis management
                </h6>
            ...
            <br></br>
            <div class='card'>
              <img src={sponsorship}></img>
              <div class='text'>
                <h4 id='para1'>Sponsorship & Marketing</h4>
                <h6 id='para2'>
                  Collaborating with brands for Sponsors and Partners, devising
            ...
            <br></br>
            <div class='card'>
              <img src={initiatives}></img>
              <div class='text'>
                <h4 id='para1'>Initiatives</h4>
                <h6 id='para2'>
                  Plans social initiatives and events which create a difference
                  in society.
                </h6>
            ...
            <div class='card'>
              ...
              <div class='text'>
                <h4 id='para1'>Workshops</h4>
                <h6 id='para2'>
                  Planning and organizing Workshops, common registration
                </h6>
            ...
            <div class='card'>
              ...
              <div class='text'>
                <h4 id='para1'>Creatives</h4>
                <h6 id='para2'>
                  The media production team, creating content in every possible
                  digital art form
                </h6>
        ...
        <div className='col'>
          <div class='card'>
            ...
            <div class='text'>
              ...
              <h6 id='para2'>
                Establishing fest throughout India by collaborating for events.
              </h6>
